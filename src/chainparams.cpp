...
{
    const char* pszTimestamp = "sucrecoin";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1000000;  //~ 4 yrs at 1 min block time
        ...
        genesis = CreateGenesisBlock(1545354000, 9351779, 0x1e00ffff, 2, 4 * COIN); 

        consensus.hashGenesisBlock = genesis.GetHash();        
        //std::cout << consensus.hashGenesisBlock.GetHex() << "\n";
        //std::cout << "Merkle: " << genesis.hashMerkleRoot.GetHex() << "\n";

        assert(consensus.hashGenesisBlock == uint256S("0x0000002db02be58896b2467ee86f4e477203d80d00ffbd3d40ac9649a1ad21ff"));
        assert(genesis.hashMerkleRoot == uint256S("0x8fc35d19b352bb7040e7bc470c2042fcd032a0fdf4efbf0cec75d67851ede1be"));
        ...
        chainTxData = ChainTxData{
            ...
            1545354000, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1545354000, 4791361, 0x1e00ffff, 2, 4 * COIN); 
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        //vSeeds.emplace_back("seed-testnet-sucrecoin.sucrecoin.org", false); 
        //vSeeds.emplace_back("seed-testnet-sucrecoin.bitactivate.com", false); 
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1545354000, 2, 0x207fffff, 4, 4 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
