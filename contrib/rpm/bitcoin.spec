...
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 2102
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 2103
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 12102
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 12103
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 2102
	%{_sbindir}/semanage port -d -p tcp 2103
	%{_sbindir}/semanage port -d -p tcp 12102
	%{_sbindir}/semanage port -d -p tcp 12103
